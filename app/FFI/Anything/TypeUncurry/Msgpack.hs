...
class MessagePackRec l where
  fromObjectRec :: [MSG.Object] -> Maybe (TypeList l)
  -- fromObjectRec :: (Monad m) => [MSG.Object] -> m (TypeList l) --- changed this cause it was giving an error
...
-- getTypeListFromMsgpackArray :: forall m l . (MessagePackRec l, ParamLength l, Monad m) => MSG.Object -> m (TypeList l) ---changed this cause it was giving an error
getTypeListFromMsgpackArray obj = case obj of
    MSG.ObjectArray v | length v == len -> fromObjectRec $ toList v
    -- MSG.ObjectArray v | length v == len -> fromObjectRec v --- changed this cause it was giving an error
